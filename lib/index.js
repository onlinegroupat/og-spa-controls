...
const Icon = (props) => __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("i", null, props.children);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ClassList__ = __webpack_require__(0);
...
class Button extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    render() {
        ...
        return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", Object.assign({ className: __WEBPACK_IMPORTED_MODULE_1__ClassList__["a" /* ClassList */].compute(className, primary && 'primary') }, buttonProps),
            icon && __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_2__Icon__["a" /* Icon */], null, icon),
            ' ',
            children));
    }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_og_ts_enum_src_index__ = __webpack_require__(8);

const MaterialIcon = __WEBPACK_IMPORTED_MODULE_0_og_ts_enum_src_index__["a" /* Enum */].fromObject({
...
/* harmony export (immutable) */ __webpack_exports__["a"] = MaterialIcon;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_uuid__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_uuid___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_uuid__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ClassList__ = __webpack_require__(0);
var __rest = (this && this.__rest) || function (s, e) {
    var t = {};
    for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p) && e.indexOf(p) < 0)
        t[p] = s[p];
...
class TextAreaInput extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor(props) {
        super(props);
        this.handleChange = (e) => {
            this.updateState();
    ...
    render() {
        ...
        return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: __WEBPACK_IMPORTED_MODULE_2__ClassList__["a" /* ClassList */].compute(className, this.state.empty ? 'empty' : 'not-empty') },
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("textarea", Object.assign({ id: this.id, onChange: this.handleChange, ref: this.handleRef }, textareaProps)),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("label", { htmlFor: this.id }, this.props.label),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "bar" }),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "validation-message" }, this.state.validationMessage)));
    }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = TextAreaInput;
...
class TextInput extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor(props) {
        super(props);
        this.handleChange = (e) => {
            this.updateState();
    ...
    render() {
        ...
        return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: __WEBPACK_IMPORTED_MODULE_2__ClassList__["a" /* ClassList */].compute(className, this.state.empty ? 'empty' : 'not-empty') },
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("input", Object.assign({ id: this.id, onChange: this.handleChange, ref: this.handleRef }, inputProps)),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("label", { htmlFor: this.id }, this.props.label),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "bar" }),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "validation-message" }, this.state.validationMessage)));
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TextInput__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TextAreaInput__ = __webpack_require__(6);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "TextAreaInput", function() { return __WEBPACK_IMPORTED_MODULE_1__TextAreaInput__["a"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Icon__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__MaterialIcon__ = __webpack_require__(5);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "MaterialIcon", function() { return __WEBPACK_IMPORTED_MODULE_4__MaterialIcon__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ClassList__ = __webpack_require__(0);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "ClassList", function() { return __WEBPACK_IMPORTED_MODULE_5__ClassList__["a"]; });
